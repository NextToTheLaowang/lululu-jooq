...
public class LwMemberCard implements Serializable {

    private static final long serialVersionUID = -218819959;
    ...
    public LwMemberCard(LwMemberCard value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("LwMemberCard (");
