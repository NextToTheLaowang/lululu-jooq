...
public class LwGoodsDao extends DAOImpl<LwGoodsRecord, com.gen.tables.pojos.LwGoods, Long> {

    /**
     * Create a new LwGoodsDao without any configuration
     */
    public LwGoodsDao() {
        super(LwGoods.LW_GOODS, com.gen.tables.pojos.LwGoods.class);
    }
    ...
    public LwGoodsDao(Configuration configuration) {
        super(LwGoods.LW_GOODS, com.gen.tables.pojos.LwGoods.class, configuration);
    }
     ...
     */
    @Override
    protected Long getId(com.gen.tables.pojos.LwGoods object) {
        return object.getId();
    }
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchById(Long... values) {
     ...
     */
    public com.gen.tables.pojos.LwGoods fetchOneById(Long value) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByCreateDate(LocalDateTime... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByUpdateDate(LocalDateTime... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByRemarks(String... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByDelFlag(UInteger... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByShopId(Long... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByGoodsName(String... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByPrice(BigDecimal... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByIntegral(Integer... values) {
     ...
     */
    public List<com.gen.tables.pojos.LwGoods> fetchByState(Integer... values) {
