...
public class LwOrder extends TableImpl<LwOrderRecord> {
    ...
    private static final long serialVersionUID = -335630376;
     ...
     */
    public final TableField<LwOrderRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>LW.lw_order.create_date</code>. 创建时间
     */
    public final TableField<LwOrderRecord, Timestamp> CREATE_DATE = createField("create_date", org.jooq.impl.SQLDataType.TIMESTAMP, this, "创建时间");

    /**
     * The column <code>LW.lw_order.update_date</code>. 更新时间
     */
    public final TableField<LwOrderRecord, Timestamp> UPDATE_DATE = createField("update_date", org.jooq.impl.SQLDataType.TIMESTAMP, this, "更新时间");

    /**
     * The column <code>LW.lw_order.remarks</code>. 备注信息
     */
    public final TableField<LwOrderRecord, String> REMARKS = createField("remarks", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "备注信息");
     ...
     */
    public final TableField<LwOrderRecord, String> ORDER_NO = createField("order_no", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "订单号");

    /**
     * The column <code>LW.lw_order.order_money</code>. 订单金额
     */
    public final TableField<LwOrderRecord, BigDecimal> ORDER_MONEY = createField("order_money", org.jooq.impl.SQLDataType.DECIMAL.precision(20, 6), this, "订单金额");

    /**
     * The column <code>LW.lw_order.pay_money</code>. 实际支付金额
     */
    public final TableField<LwOrderRecord, BigDecimal> PAY_MONEY = createField("pay_money", org.jooq.impl.SQLDataType.DECIMAL.precision(20, 6), this, "实际支付金额");
     ...
     */
    public final TableField<LwOrderRecord, Timestamp> PAY_TIME = createField("pay_time", org.jooq.impl.SQLDataType.TIMESTAMP, this, "支付时间");
     ...
     */
    public final TableField<LwOrderRecord, String> GOODS_NAME = createField("goods_name", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");

    /**
     * The column <code>LW.lw_order.goods_price</code>.
     */
    public final TableField<LwOrderRecord, BigDecimal> GOODS_PRICE = createField("goods_price", org.jooq.impl.SQLDataType.DECIMAL.precision(20, 6), this, "");
    ...
    private LwOrder(String alias, Table<LwOrderRecord> aliased) {
        this(alias, aliased, null);
    }

    private LwOrder(String alias, Table<LwOrderRecord> aliased, Field<?>[] parameters) {
