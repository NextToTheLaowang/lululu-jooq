...
public class LwMember extends TableImpl<LwMemberRecord> {
    ...
    private static final long serialVersionUID = 2144991572;
     ...
     */
    public final TableField<LwMemberRecord, Timestamp> CREATE_DATE = createField("create_date", org.jooq.impl.SQLDataType.TIMESTAMP, this, "创建时间");

    /**
     * The column <code>LW.lw_member.update_date</code>. 更新时间
     */
    public final TableField<LwMemberRecord, Timestamp> UPDATE_DATE = createField("update_date", org.jooq.impl.SQLDataType.TIMESTAMP, this, "更新时间");

    /**
     * The column <code>LW.lw_member.remarks</code>. 备注信息
     */
    public final TableField<LwMemberRecord, String> REMARKS = createField("remarks", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "备注信息");
     ...
     */
    public final TableField<LwMemberRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "姓名");

    /**
     * The column <code>LW.lw_member.mobile</code>. 电话
     */
    public final TableField<LwMemberRecord, String> MOBILE = createField("mobile", org.jooq.impl.SQLDataType.VARCHAR.length(64), this, "电话");

    /**
     * The column <code>LW.lw_member.photo</code>. 照片
     */
    public final TableField<LwMemberRecord, String> PHOTO = createField("photo", org.jooq.impl.SQLDataType.VARCHAR.length(1024), this, "照片");
     ...
     */
    public final TableField<LwMemberRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR.length(1024), this, "地址");

    /**
     * The column <code>LW.lw_member.birthday</code>.
     */
    public final TableField<LwMemberRecord, Date> BIRTHDAY = createField("birthday", org.jooq.impl.SQLDataType.DATE, this, "");
    ...
    private LwMember(String alias, Table<LwMemberRecord> aliased) {
        this(alias, aliased, null);
    }

    private LwMember(String alias, Table<LwMemberRecord> aliased, Field<?>[] parameters) {
