...
public final class StringTools {
    ...
    private final static String regx = "(([\u4E00-\u9FA5]{2,7}))";
    ...
    public static boolean isMobile(String mobile){
        ...
        String pat = "^(1[0-9])\\d{9}$";
        return  Pattern.matches(pat,mobile);
    }
    ...
    public static String maskPlaCustId(String plaCustId) {
        if (StringUtils.isEmpty(plaCustId)) {
            return "";
        }
        return maskMidString(plaCustId, ASTERISK, 4, 5);
    }
...
//    }
     ...
     * @return
     */
    public static String getRandomNumToStr(int len) {
...
//        }
    ...
    public static StringBuffer buildSign(Map<String, String> params) {
    ...
    public static String arryToString(Long[] longs) {
    ...
    public static String listToString(List<Long> longs) {
        if (longs != null && longs.size() > 0) {
            if (longs.size() == 1) {
                return String.valueOf(longs.get(0));
            } else {
                StringBuffer stringBuffer = new StringBuffer();
                for (Long l : longs) {
                    stringBuffer.append(l).append(",");
    ...
    public static List<Long> stringToLongArray(String s) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isNumInteger("123h66", 6));
    }
    ...
    public static String stringSubstring(String s) {
        ...
        if (str.indexOf("?") > -1) {
            String string = s.substring(0, str.lastIndexOf("?"));
            return string;
        }
        return str;
    }
    ...
    public static String stringMoney(String money) {
        ...
        if (isNotBlank(money)) {
            ...
            moneys = (double) Math.round(moneys * 100) / 100;
            money = String.valueOf(moneys);
            return money;
        }
        return mon;
    }
     ...
     * @return
     */
    public static String stringDeletNull(String nu) {
        String nl = "";
        if ("null".equals(nu)) {
            return "";
        }
    ...
    public static boolean isNumInteger(String str, int num) {
