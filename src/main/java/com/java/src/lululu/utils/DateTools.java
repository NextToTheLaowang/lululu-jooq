...
public class DateTools {
     ...
     * date format yyyy年MM月dd日 HH:mm:ss
     */
    public static final String TIME_PATTERN_SHORT_3 = "yyyy年MM月dd日";
    ...
    public static final String DATE_FMT_19 = "yyyymmddhhMMss";
    ...
    public static Date stringToDate(String str, String fmt) {
        if (StringTools.isBlank(str) || StringTools.isBlank(fmt)) {
            return null;
        }
  ...
  /*  public static boolean isWorkDay(Date date){
        ...
        if (sysDictService.checkDateIsWorkday("check_holidays")||isWeekend(date)){
            workday = false;
        }
        if (sysDictService.checkDateIsWorkday("special_workday")){
            workday = true;
        }
        return workday;
    }*/
    ...
    public static Date getDateYYYYMMDD() {
        ...
        return getDate(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) + 1, calendar.get(Calendar.DATE));
    }
    ...
    public static Date appendDateAndTime(String date, String time) {
        return appendDateAndTime(date, time, "yyyy-MM-dd HH:mm");
    }
     ...
     * @return
     */
    public static Date appendDateAndTime(String date, String time, String format) {
        if (StringUtils.isEmpty(date) || StringUtils.isEmpty(time) || StringUtils.isEmpty(format)) {
            return null;
        }
        ...
        if (StringTools.isNotBlank(date) && StringTools.isNotBlank(time)) {
            ssBuffer.append(date.trim()).append(" ").append(time.trim());
        }
        Date dd = null;
        try {
            if (StringUtils.isNotEmpty(ssBuffer.toString())) {
...
//        cal.set(Calendar.MILLISECOND, 999);
     ...
     * @return
     */
    public static boolean isYeePayWorkTime() {
        Date now = getCurrentDate();
        int weekOfDate = getDayOfWeek(now);
        //周六和周日， 不是工作时间
        if (weekOfDate == 1 || weekOfDate == 7) {
            return false;
        }
        /*if (!isWorkDay(now)){
            return false;
        ...
        Date endDay = instance.getTime();

        return isDayInRange(startDay, endDay);
    }
    ...
    public static Timestamp formatTimestamp(String str) {
        DateFormat format = new SimpleDateFormat(DateTools.DATE_FMT_3);
    ...
    public static String getTimeStamp() {
        ...
        long timeInMillis = getCurrentCalendar().getTimeInMillis();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String sd = sdf.format(new Date(Long.parseLong(String.valueOf(timeInMillis))));
        return sd;
    }
    ...
    public static boolean verifyYYMM(String date) {
        try {
...
//        System.out.println(daysBetween(DateTools.addDate(new Date(), 1), DateTools.addDate(new Date(), 3)));
        System.out.println(formatTimestamp("2018-01-12 12:22:00"));
//        System.out.println(isWeekend(new Date("April 09,2018")));
